...
function UserDetails (user) {
  return (
    <div>
      ...
      <li className="list-group-item"> <img src={user.info.avatar_url} className="img-rounded img-responsive" style={{width: '150px'}} /></li>
...
UserDetails.propTypes = {
  // PropTypes.shape() allows you to validate the properties of an object
